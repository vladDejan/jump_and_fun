...
import Octopus0 from "../assets/images/octopus/octopus0.webp";
import Octopus1 from "../assets/images/octopus/octopus1.webp";
import Octopus2 from "../assets/images/octopus/octopus2.webp";
import Octopus3 from "../assets/images/octopus/octopus3.webp";
import "../index.css";
import {
  Accordion,
  AccordionItem,
...
const cards: Card[] = [
  {
    ...
    image: Octopus0,
    description:
      "Stvoren da privuče pažnju i probudi maštu najmlađih! Hobotnica Tematski Dvorac pruža nezaboravnu avanturu i postaje glavno mesto za igru, smeh i druženje na svakom događaju.",
  },
  {
    id: 2,
    title: "Karakteristike",
    image: Octopus1,
    description: `• Preporučeni uzrast: 2–12 godina
• Kapacitet: Do 12 dece istovremeno
• Dimenzije: 5 m (širina) × 5 m (dužina) × 3,5 m (visina)
...
• Cena: 250€`,
  },
  {
    ...
    image: Octopus2,
    description:
      "Ako tražite dvorac na naduvavanje koji je atraktivan, razigran i pun boja – Hobotnica Tematski Dvorac je idealan izbor. Njegov upečatljiv dizajn i veće dimenzije čine ga savršenim za dinamičnu igru i pravu avanturu.",
  },
  {
    id: 4,
    title: "",
...
export const Octopus = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Hobotnica - Iznajmljivanje za Dečije Proslave | Jump and Fun</title>
        <meta 
          name="description" 
          content="Iznajmite Hobotnica na naduvavanje za krštenja, rođendane i svečane proslave u Novom Sadu. Bazen sa lopticama uključen!" 
        />
        <link rel="canonical" href="https://www.jumpandfun.rs/programs/mali-dvorac" />
        
        <meta property="og:title" content="Hobotnica - Jump and Fun" />
        <meta property="og:description" content="Hobotnica savršen za krštenja i rođendane sa bazenom sa lopticama." />
        ...
        <div className="mt-10 flex flex-col items-center max-w-2xl mx-auto">
          ...
          >
            <AccordionItem value="item-1">
              <AccordionTrigger>
                Da li je moguće produžiti najam Hobotnice?
              </AccordionTrigger>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>
                Gde je moguće iznajmiti Hobotnicu?
              </AccordionTrigger>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-primary accordion-content data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up flex flex-col gap-4 text-balance">
                Da! Hobotnica je idealan za dvorišta, parkove i druge ravne
                površine.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent className="text-primary accordion-content data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up flex flex-col gap-4 text-balance">
                Nema problema! Hobotnica je jednako kompaktan uz unutrašnje
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent className="text-primary accordion-content data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up flex flex-col gap-4 text-balance">
                Hobotnica je prvenstveno namenjen dvorac za decu, ne za odrasle.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
